...
export class Merge {
    ...
    changes: any;
    conflicts: any;
    conflictingSteps: any;
    conflictingSteps1: any;
    conflictingSteps2: any;
    ...
    map(mapping, doc) {
        let { conflictingSteps1 } = this,
            { conflictingSteps2 } = this,
            { conflicts } = this,
            { conflictingChanges } = this;
    ...
    apply(user, index) {
        ...
        const conflictingChanges = this.conflictingChanges.filter(change => {
    ...
    reject(user, index) {
        let { conflictingSteps1, conflictingSteps2, conflicts } = this;

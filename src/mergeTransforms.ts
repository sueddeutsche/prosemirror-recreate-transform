...
export class Merge {
    ...
    changes: any;
    conflicts: Array<any>;
    conflictingSteps: Array<any>;
    conflictingSteps1: Array<any>;
    conflictingSteps2: Array<any>;
    ...
    map(mapping, doc) {
        let { conflictingSteps1 } = this,
            ...
            { conflicts } = this,
            { inserted } = this.conflictingChanges,
            { deleted } = this.conflictingChanges;
    ...
    tr.steps.forEach(step => {
        ...
        if (mapped) {
            try {
                ...
                // this is not working - all errors are discarded
